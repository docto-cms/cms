  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white">
      <div>
        ...
        <div className="flex overflow-hidden m-auto p-3 w-[400px]">
          <div
            className="flex-1 text-center p-4 bg-blue-400 border border-gray-500 text-white cursor-pointer"
            onClick={() => handleClick("Scheduled")}
          >
            Scheduled <h1>{scheduledCount}</h1>
          </div>
          <div
            className="flex-1 text-center p-4 bg-green-500 border border-gray-500 text-white cursor-pointer"
            onClick={() => handleClick("Waiting")}
          >
            Waiting <h1>{waitingCount}</h1>
          </div>
          <div
            className="flex-1 text-center p-4 bg-yellow-500 border border-gray-500 text-white cursor-pointer"
            onClick={() => handleClick("Engaged")}
          >
            Engaged <h1>{engagedData.length}</h1>
          </div>
          <div
            className="flex-1 text-center p-4 border border-gray-700 cursor-pointer"
        ...
        {selectedTab === "Scheduled" && scheduledCount > 0 && (
          <div className="p-4 bg-white border rounded shadow-md mt-4 flex items-center">
        ...
        {selectedTab === "Waiting" && waitingData.length > 0 ? (
          waitingData.map((patient, index) => (
            <div
              key={index}
              className="p-4 bg-white border rounded shadow-md mt-4 flex items-center"
            >
              <div className="flex flex-col justify-center items-center mr-4">
                <p className="text-gray-800 flex items-center">
                  <span className="h-3 w-3 rounded-full bg-green-500 mr-2"></span>
